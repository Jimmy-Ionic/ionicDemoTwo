        ...
        */
        ...
        if (!alreadyShrunk || changedKeyboardHeight) {
          ...
          if ( !isPopover && (ionic.Platform.isIOS() || ionic.Platform.isFullScreen || isInsetModal) ) {
            ...
            // subtract them from the keyboard height when resizing
            // E - D                         E                         D
            //var scrollBottomOffsetToBottom = e.blank.viewportHeight - scrollBottomOffsetToTop;

            // 0 or D - B if D > B           E - B                     E - D
            //var keyboardOffset = e.blank.keyboardHeight - scrollBottomOffsetToBottom;
            ...
            ionic.requestAnimationFrame(function(){
              ...
              //console.log('Old container height', self.__originalContainerHeight, 'New container height', scrollViewOffsetHeight, 'Keyboard height', e.blank.keyboardHeight);
        ...
        if (e.detail.isElementUnderKeyboard) {
          ...
          ionic.requestAnimationFrame(function(){
            ...
            // middle of the input we want to scroll into view
            // C
            var inputMidpoint = ((e.blank.elementBottom + e.blank.elementTop) / 2);
